...
export default async function Home({ params }: { params: Promise<{ lang: string }> }) {
  ...
  const [destinations, offers, attractions, searchProducts] = await Promise.all([
  ...
  return (
    <>
      ...
      <main className="flex-1">
        ...
        <Reviews lang={lang} dict={dict} cta={dict.reviews.listingCta} />
        <Destinations dict={dict} destinations={destinations} />
        <Partners dict={dict} />
